...
如此草率的断言，虽不是完全没有道理，恕在下直言一句：这两个学科之间的差别比你们想象得要大、相似度比你们想象得要低；跨行业申请的难度，比你们想象得要高。
...
带入标准数独的行列数 n=9，以上两式分别得 11988 和 10530<sup>[1]</sup>。相比于穷举法要快很多自不必说，甚至，这种解法的效率并不比后面要讨论的舞蹈链低。

[1]<small>这两个数字是针对每一个 9x9 的数独来说，需要尝试的循环次数，与上文 5475730538 这个数字含义不同。</small>
