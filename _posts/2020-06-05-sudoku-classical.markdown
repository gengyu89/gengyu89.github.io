...
如果说要学好一门技能，九成靠的是自学的话，那往往这 10% 的引导和启发是最重要的。我那时所接触到的程序设计方法对我至今影响深刻，虽然这些训练只能让我成为一个新手，好在我走的是以算法为核心的正规化学习路线。Computer Science 如同纯数学，有原理有结论，是一门**理论性很强的研究型学科**。大多数国外大学的 CS 专业会把教学精力集中于算法，编程语言作为工具，需要自己去学。外行人眼中 “教会你熟练使用各种编程语言” 之理解，近乎和 “能用最基础的方法和最少量的公式还原一个三阶魔方” 差不多肤浅。
