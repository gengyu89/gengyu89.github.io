...
这么多年下来，据我观察，该大牛之所谓 “编程爱好” 其实也就是说说而已，没看出有多大的热情。恕在下直言一点事实，不带有任何偏见：**学了这么多年，没感受到有多少相似的地方**，稍微做过一点点调查的人都不会得出这样的结论来。毫不留情地说，Computer Scientists 研究的内容基本上跟这个专业是完全不同的概念，这种差距绝非是普通人经过一两个月的自学可以弥补的。恕我直言，CS 专业的作业题，以地球物理的方式来写，有一多半都过不了运行时间的限制。恕直言，地球物理这个专业的人毕业后想从事和编程相关的工作，还得从基本原理开始学起！
...
如果说要学好一门技能，九成靠的是钻研和自学，那往往这 10% 的启发和引导是最重要的。我那时所接触到的程序设计方法对我至今影响深刻，尽管这些训练只能让我成为一个新手，好在我走的是以算法为核心的正规化学习路线。Computer Science 如同纯数学，有推导有结论，是一门**理论性很强的研究型学科**。大多数国外大学的 CS 专业会把教学精力集中于算法，编程语言作为工具，需要自己去学。外行人眼中*教会你熟练使用各种编程语言*之理解，近乎和*能用最基础的方法和最少量的公式还原一个三阶魔方*差不多肤浅。

广义地讲，即使你平时科研最常使用的工具是 C++ 的话，那么**对于同一门编程语言，软件工程师使用它的方法与地球物理学家有着天壤之别**。遗憾的是，“熟练地使用终端命令、脚本语言和入门水准的 C++ 完成数据处理” 这些科研人员必会技能，都没有触及 CS 的核心技术。*五种常用的编程范式你会几种？23 种设计模式你都懂多少？*这些，是当你说出自己 “喜欢编程” 这句话时，其他人最先关注的问题。否则… 又怎么好意思说自己会编程序呢？

> 所以你确定自己真懂？

在我看来，ACM 一类的比赛尽管存在争议，对于大学生的程序设计能力是一种良好的训练。软件是由模块组成的 —— 不同人员开发的代码借由 API 相互调用、协同运作，只有当每一个部件都优化到位，才能将整体的性能发挥到极致。考虑到硬件的更新速度赶不上数据量的增长，从这个角度来讲，算法比赛和研究的意义始终不容忽略。我虽代表不了这个学科的最高水平，希望以数独为例，引出算法比赛里的一些非常基础的优化方法。
