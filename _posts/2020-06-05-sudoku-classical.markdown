...
作为 CS 这个学科里的过来人，我一直很想写一个什么东西来澄清一些见解，谈一谈程序员之间怎么拼内功。换一个方式来讲，我 CSers 固然都是写代码的，你地球物理学家也算是写代码的，此 “编程” 与彼 “编程” 有何本质上区别？我系某大牛（科大来的）相信 “搞地球物理的能当程序员使”，用来回答 “地球物理专业学完是不是能当半个 CS 使？” 这个问题，其依据是前辈里有一位进游戏公司写代码。按照我的理解，3D 建模软件中烟雾和流体特效主要靠纳维叶-斯托克斯方程来模拟。若是这位师兄当年做流体力学的，倒是看得出有一定的相似之处。

这么多年下来，我感觉这位同学的 “编程爱好” 也只是说说而已。如此草率的断言，虽不是完全没有道理，恕我直言一句：真把编程当爱好的人，绝不会得出这种结论来。这两个学科之间的差别有点大，相似度比一般人想象得要低；跨行业申请的难度，比一般人想象得要高。当程序员恐怕是不行了，真有这样的志向，也得从现在起一点一滴地积累才行得通呢！

#### —— 基本理论和性质 ——

开博第一篇，先跟大家交待我的学习背景。

在加拿大攻读计算机科学辅修学位，翻看过数学家 Kenneth H. Rosen 的数论教材，研究过包括 SICP 在内的计算机科学经典教材并因此而学了函数式编程 Common-Lisp（强制你形成递归的思维），见识过各种各样牛逼的解题方法… Java 和 Python，是我那时为了读算法书而学的。对于这个领域内的各种出题套路和比赛规则，我已经接触过太多了。
...
如果说要学好一门技能，九成靠的是自学的话，那往往这 10% 的引导和启发是最重要的。我那时所接触到的程序设计方法对我至今影响深刻，尽管这些训练只能让我成为一个新手，好在我走的是以算法为核心的正规化学习路线（Computer Science 并不是一个教你熟练运用各种编程语言 + 开发框架的专业）。

在我看来，ACM 一类的比赛尽管存在争议，对大学生的程序设计能力是一种良好的训练 —— 软件是由模块构成的，只有当每一个部件都优化到位，才能将整体的性能发挥到极致，算法比赛的重要性不容忽略。我虽代表不了这个学科的最高水平，希望以数独为例，引出算法比赛里的一些非常基础的优化方法。
