...
这么多年下来，据我观察，该大牛之所谓 “编程爱好” 其实也就是说说而已，没看出有多大的热情。恕在下直言一点事实，不带有任何偏见：**学了这么多年，没感受到有多少相似的地方**，稍微做过一点点调查的人都不会得出这样的结论来。

毫不留情地说，Computer Scientists 研究的内容基本上跟这个专业是完全不同的概念，这种差距绝非是普通人经过一两个月的自学可以弥补的。恕我直言，CS 专业的作业题，以地球物理的方式来写，有一多半都过不了运行时间的限制。恕直言，地球物理这个专业的人毕业后想从事和编程相关的工作，还得从基本原理开始学起！*五种常用的编程范式你会几种？23 种设计模式你都懂多少？*当其他人听你说出 “我喜欢编程” 这句话时，最关注的其实是这些问题。否则… 又怎么好意思说自己会编程序呢？
...
广义地讲，即使你平时科研最常使用的工具是 C++ 的话，**对于同一门编程语言，软件工程师使用它的方法与地球物理学家有着天壤之别**。遗憾的是，“熟练地使用终端命令、脚本语言和入门水准的 C++ 完成数据处理” 这些科研人员必会技能，都没有触及 CS 的核心技术。
