...
作为科班出身的 Computer Scientist，我一直希望以过来人身份来澄清某些看法，谈一谈程序员之间怎么拼内功。换一个方式来讲，我 CSers 固然都是写代码的，你地球物理学家也算是写代码的，此 “编程” 与彼 “编程” 有何本质上区别？我系某大牛（张佳）相信 “地球物理学家能当程序员使”，用来回答 “地球物理专业学完是不是能当半个 CS 使？” 这个问题。无论其依据何在，这听起来似乎有点离谱。

这么多年下来，我感觉这位大牛之所谓 “编程爱好” 也就说说而已，没怎么落实到行动上。恕在下直言一个事实，不带有任何偏见：**稍微做过一点调查的人，都不会得出这样的结论来**。这两个学科一直没能做到很好的桥接，Computer Scientists 研究的内容完全就跟地球物理学家两码事，这种差别绝非是普通人经过一两个月的自学可以弥补（跨行业申请的难度，比一般人想象得要高）的。当程序员恐怕是行不了，真有这样的志向，从现在起一点一滴地积累才行得通呢！
...
在加拿大攻读计算机科学辅修学位，翻看过数学家 Kenneth H. Rosen 的数论教材，研究过包括 SICP 在内的计算机科学经典教材并因此而学了函数式编程 Common-Lisp（强制你形成递归的思维），见识过各种各样牛逼的解题方法… Java 和 Python 是我那时为了读算法书而学的。知道这个圈子的水有多深，对于这个领域内的各种出题套路和比赛规则，我都非常了解。听到周围一些学地球物理的人说自己 “喜欢编程”，总是觉得他们很幼稚。
...
如果说要学好一门技能，九成靠的是自学的话，那往往这 10% 的引导和启发是最重要的。我那时所接触到的程序设计方法对我至今影响深刻，尽管这些训练只能让我成为一个新手，好在我走的是以算法为核心的正规化学习路线。Computer Science 如同纯数学，有原理有结论，是一门**理论性很强的研究型学科**。大多数国外大学的 CS 专业会把教学精力集中于算法，编程语言作为工具，需要自己去学。外行人眼中的 “教会你熟练使用各种编程语言” 之理解，近乎和 “能用最基础的方法和最少量的公式还原一个三阶魔方” 差不多肤浅。

在我看来，ACM 一类的比赛尽管存在争议，对于大学生的程序设计能力是一种良好的训练。软件是由模块组成的 —— 不同人员开发的代码借由 API 相互调用、协同运作，只有当每一个部件都优化到位，才能将整体的性能发挥到极致。野路子上来的程序员经过短期的培训，表面上看起来什么都懂，内功拼起来差得很远。电脑硬件的革新速度赶不上数据量的增长，从这个角度来讲，算法比赛和研究的意义始终不容忽略。我虽代表不了这个学科的最高水平，希望以数独为例，引出算法比赛里的一些非常基础的优化方法。
...
看到这种摸不着边的公式兄弟们作何感想？不带一个积分符号、微分算子，小学生都能看懂，要想推导出它们却绝非初等知识… 数论书里到处都是这种惊艳的结论。
