...
作为 CS 这个学科里的过来人，我一直很想写一个什么东西来澄清一些见解，谈一谈程序员之间怎么拼内功。换一个方式来讲，我 CSers 固然都是写代码的，你地球物理学家也算是写代码的，此 “编程” 与彼 “编程” 有何本质上区别？我系某大牛（科大来的）相信 “搞地球物理的能当程序员使”，用来回答 “地球物理专业学完是不是能当半个 CS 使？” 这个问题，其依据是前辈里有一位进游戏公司写代码。这句话不仅激怒了我，也让我开始重新地思考人生。按照我的理解，3D 建模软件中烟雾和流体特效主要靠纳维叶-斯托克斯方程来模拟。若是这位师兄当年做流体力学的，倒是看得出有一定的相似之处。

这么多年下来，我没有看出说这话的同学自己有接受多少这方面的训练。如此草率的断言，虽不是完全没有道理，恕在下直言：稍微做过一点调查的人都不会这么说。这两个学科之间的差别比你们想象得要大、相似度比你们想象得要低；跨行业申请的难度，比你们想象得要高。当程序员使恐怕是不行了，真有这样的志向，也得从现在起一点一滴地积累才行得通呢！

#### —— 基本理论和性质 ——

开博第一篇，先跟大家交待我的学习背景。

在加拿大攻读计算机科学辅修学位，翻看过数学家 Kenneth H. Rosen 的数论教材，研究过包括 SICP 在内的计算机科学经典教材并因此而学了函数式编程 Common-Lisp（强制你形成递归的思维），见识过各种各样牛逼的解题方法… Java 和 Python，也是我那时为了读算法书而学的。对于这个领域内的各种出题套路和比赛规则，我都略有了解。

至于说地球物理学家能不能当程序员使，您别跟我争论，找个学地球物理的人来解释一下：*二叉树有三种遍历方法 —— 前序、中序和后序*，这话什么意思？或者我给您出一道 CS 专业的题，看地球物理这个专业的人写出来的算法能不能通过在线的提交系统，然后就知道了。对不起，国外大学都这么做的。
...
如果说要学好一门技能，九成靠的是自学的话，那往往这 10% 的引导和启发是最重要的。我那时所接触到的程序设计方法对我至今影响深刻，尽管这些训练只能让我成为一个新手，好在我走的是以算法为核心的正规化学习路线（Computer Science 并不是一个教你熟练掌握各种编程语言 + 开发框架的专业）。

在我看来，ACM 一类的比赛尽管存在争议，对大学生的程序设计能力是一种良好的训练 —— 由于软件是由模块构成的，只有当每一个部件都优化到位，才能将整体的性能发挥到极致，所以算法比赛的重要性不容忽略。我虽代表不了这个学科的最高水平，希望以数独为例，引出算法比赛中的一些初等的优化方法。
...
可见编程其实很难，难在：(0) 有些数据结构在缺少背景知识的前提下，仅凭临场发挥很难构思出来（思路难）；(1) 有些算法基本原理已经非常难懂，更别说亲自实现出来（实现难）。后者通过刷题可以逐渐克服，前者决定了你能否回答面试官问题。这个世界每时每刻，各种烧脑的算法被大牛们创造出来。即使翻过了世界上每一本算法书，还是会有你答不上来的问题，并且**在地球物理这个专业几乎没人思考这些**。
