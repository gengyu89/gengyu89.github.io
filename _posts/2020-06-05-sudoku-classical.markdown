...
在加拿大攻读计算机科学辅修学位，翻看过数学家 Kenneth H. Rosen 的数论教材，研究过包括 SICP 在内的计算机科学经典教材并因此而学了函数式编程（强制你形成递归的思维），见识过各种各样牛逼的解题方法… Common-Lisp, Java, Python… 是我那时为了读算法书而学的。知道这个圈子的水有多深，对于这个领域内的各种出题套路和比赛规则，我都稍有了解。有时听到一些周围的人说自己 “喜欢编程”，我总感觉特别幼稚。
...
客气地说，退一步讲，即使你平时最常使用的工具是 C++（并因此而觉得自己所从事的工作比其他人更接近底层）的话，我遗憾地告诉大家：**软件工程师使用它的方法与地球物理学家之间有着天壤之别**。“熟练地运用终端命令、脚本语言和入门水准的 C++” 这些科研人员所最常用到的技能，都没有触及 CS 的核心技术。*五种常用的编程范式你学过几种？23 种设计模式你都会多少？*这些，是当你说出自己 “喜欢编程” 这句话时，其他人最先关注的问题。如果连这些基本的原理都不清楚，又怎么好意思说自己会编程序呢？
