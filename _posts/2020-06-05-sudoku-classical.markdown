...
这么多年下来，我感觉这位大牛的 “编程爱好” 也就装逼而已，没怎么落实到行动上<sup>[1]</sup>。恕在下直言一点事实，不带有任何偏见：**稍微做过一点调查的人，都不会得出这样的结论来**。Computer Scientists 研究的内容完全就跟地球物理学家两码事，这种差别绝非是普通人经过一两个月的自学可以弥补（跨行业申请的难度，比一般人想象得要高）的。当程序员恐怕是行不了，真有这样的志向，从现在起一点一滴地积累才行得通呢！

[1] 曾经在一门叫 Exploration Seismology 的课上，他写的程序连跑都跑不动
...
在加拿大攻读计算机科学辅修学位，翻看过数学家 Kenneth H. Rosen 的数论教材，研究过包括 SICP 在内的计算机科学经典教材并因此而学了函数式编程 Common-Lisp（强制你形成递归的思维），见识过各种各样牛逼的解题方法… Java 和 Python 是我那时为了读算法书而学的。知道这个圈子的水有多深，对于这个领域内的各种出题套路和比赛规则，我都非常了解。有时听到一些周围的人说自己 “喜欢编程”，我总感觉非常幼稚。
...
如果说要学好一门技能，九成靠的是自学的话，那往往这 10% 的引导和启发是最重要的。我那时所接触到的程序设计方法对我至今影响深刻，尽管这些训练只能让我成为一个新手，好在我走的是以算法为核心的正规化学习路线。Computer Science 如同纯数学，有原理有结论，是一门**理论性很强的研究型学科**。大多数国外大学的 CS 专业会把教学精力集中于算法，编程语言作为工具，需要自己去学。外行人眼中 “教会你熟练使用各种编程语言” 之理解，近乎和 “能用最基础的方法和最少量的公式还原一个三阶魔方” 差不多肤浅。
